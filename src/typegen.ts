...
export interface NexusGenInputs {
  ...
  AddToWatchLaterInput: { // input type
    accountId: string; // String!
    owner: string; // String!
    profileId: string; // String!
    publishId: string; // String!
  }
  BookmarkPostInput: { // input type
    accountId: string; // String!
    owner: string; // String!
    profileId: string; // String!
    publishId: string; // String!
  ...
  CheckPublishPlaylistsInput: { // input type
    accountId: string; // String!
    owner: string; // String!
    profileId: string; // String!
    publishId: string; // String!
  ...
  CreatePlayListInput: { // input type
    accountId: string; // String!
    name: string; // String!
    owner: string; // String!
    profileId: string; // String!
  ...
  DeletePlaylistInput: { // input type
    accountId: string; // String!
    owner: string; // String!
    playlistId: string; // String!
    profileId: string; // String!
  ...
  DeletePublishesInput: { // input type
    accountId: string; // String!
    creatorId: string; // String!
    owner: string; // String!
  ...
  FetchPublishesByProfileInput: { // input type
    creatorId: string; // String!
    cursor?: string | null; // String
  ...
  FetchPublishesByQueryStringInput: { // input type
    cursor?: string | null; // String
    publishType?: NexusGenEnums['QueryPublishType'] | null; // QueryPublishType
    query: string; // String!
    requestorId?: string | null; // String
  }
  FetchPublishesByTagInput: { // input type
    cursor?: string | null; // String
    publishType?: NexusGenEnums['QueryPublishType'] | null; // QueryPublishType
    requestorId?: string | null; // String
    tag: string; // String!
  ...
  LikePublishInput: { // input type
    accountId: string; // String!
    owner: string; // String!
    profileId: string; // String!
    publishId: string; // String!
  }
  PlaylistItemStatus: { // input type
  ...
  RemoveAllBookmarksInput: { // input type
    accountId: string; // String!
    owner: string; // String!
    profileId: string; // String!
  }
  ...
  RemoveFromPlaylistInput: { // input type
    accountId: string; // String!
    owner: string; // String!
    playlistId: string; // String!
    profileId: string; // String!
  ...
  UpdatePlaylistDescriptionInput: { // input type
    accountId: string; // String!
  ...
  UpdatePlaylistNameInput: { // input type
    accountId: string; // String!
    name: string; // String!
    owner: string; // String!
    playlistId: string; // String!
  ...
  UpdatePlaylistsInput: { // input type
    accountId: string; // String!
    owner: string; // String!
  ...
  UpdatePreferencesInput: { // input type
    accountId: string; // String!
    owner: string; // String!
...
export interface NexusGenObjects {
  ...
  FetchBookmarkResponse: { // root type
  ...
  FetchPlaylistsResponse: { // root type
    edges: NexusGenRootTypes['PlaylistEdge'][]; // [PlaylistEdge!]!
    pageInfo: NexusGenRootTypes['PageInfo']; // PageInfo!
  }
  FetchPreviewPlaylistsResponse: { // root type
...
export interface NexusGenFieldTypes {
  ...
  BookmarkEdge: { // field return type
    cursor: string | null; // String
    node: NexusGenRootTypes['Bookmark'] | null; // Bookmark
  }
  ...
  FetchBookmarkResponse: { // field return type
    edges: NexusGenRootTypes['BookmarkEdge'][]; // [BookmarkEdge!]!
    pageInfo: NexusGenRootTypes['PageInfo']; // PageInfo!
  }
  ...
  FetchPlaylistsResponse: { // field return type
    edges: NexusGenRootTypes['PlaylistEdge'][]; // [PlaylistEdge!]!
    pageInfo: NexusGenRootTypes['PageInfo']; // PageInfo!
  }
  FetchPreviewPlaylistsResponse: { // field return type
    edges: NexusGenRootTypes['PreviewPlaylistEdge'][]; // [PreviewPlaylistEdge!]!
    pageInfo: NexusGenRootTypes['PageInfo']; // PageInfo!
  }
  ...
  PlaylistEdge: { // field return type
    cursor: string | null; // String
    node: NexusGenRootTypes['Playlist'] | null; // Playlist
  }
  PlaylistItem: { // field return type
    createdAt: NexusGenScalars['DateTime']; // DateTime!
    id: string; // ID!
  ...
  PlaylistItemEdge: { // field return type
    cursor: string | null; // String
    node: NexusGenRootTypes['PlaylistItem'] | null; // PlaylistItem
  }
  PreviewPlaylist: { // field return type
    count: number; // Int!
    id: string; // String!
    lastItem: NexusGenRootTypes['Publish'] | null; // Publish
    name: string; // String!
  }
  PreviewPlaylistEdge: { // field return type
    cursor: string | null; // String
    node: NexusGenRootTypes['PreviewPlaylist'] | null; // PreviewPlaylist
  }
  ...
  Query: { // field return type
    ...
    fetchPublishesByQueryString: NexusGenRootTypes['FetchPublishesResponse'] | null; // FetchPublishesResponse
...
export interface NexusGenFieldTypeNames {
  ...
  BookmarkEdge: { // field return type name
    cursor: 'String'
    node: 'Bookmark'
  }
  ...
  FetchBookmarkResponse: { // field return type name
    edges: 'BookmarkEdge'
    pageInfo: 'PageInfo'
  }
  ...
  FetchPlaylistsResponse: { // field return type name
    edges: 'PlaylistEdge'
    pageInfo: 'PageInfo'
  }
  FetchPreviewPlaylistsResponse: { // field return type name
  ...
  PlaylistEdge: { // field return type name
    cursor: 'String'
    node: 'Playlist'
  }
  PlaylistItem: { // field return type name
    createdAt: 'DateTime'
    id: 'ID'
    playlist: 'Playlist'
    playlistId: 'String'
  ...
  PlaylistItemEdge: { // field return type name
    cursor: 'String'
    node: 'PlaylistItem'
  }
  PreviewPlaylist: { // field return type name
    count: 'Int'
    id: 'String'
    lastItem: 'Publish'
    name: 'String'
  }
  PreviewPlaylistEdge: { // field return type name
    cursor: 'String'
